...
from bioos_benchmark.data import AA20, RawRecord, grouped_percentile_scores, normalize_sequence, percentile_scores
...
def test_grouped_percentile_scores_do_not_compare_across_assays():
    records=[
        RawRecord("a","x","","AAA","","",1.0,1,"g1"),
        RawRecord("a","x","","AAA","","",2.0,1,"g1"),
        RawRecord("a","x","","AAA","","",100.0,1,"g2"),
    ]
    assert grouped_percentile_scores(records)==[0.0,1.0,0.5]
